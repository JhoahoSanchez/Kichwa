...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String resultado = "";
        do {
            numeroIngresado = JOptionPane.showInputDialog("\tConversor de numeros a kichwa\nIngrese un número:\n");
            if (validacion.validarNumero(numeroIngresado)) {
                resultado = conversor.convertirNumero(Integer.parseInt(numeroIngresado));
                JOptionPane.showMessageDialog(null, ("Numero en kichwa: " + resultado));
            } else {
                JOptionPane.showMessageDialog(null, "Introduzca un número entre el 0 y 9999");
            }
            respuesta = JOptionPane.showInputDialog("Desea introducir otro numero? si/no");
